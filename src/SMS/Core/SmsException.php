 ...
 * Class SmsException
 *
 * This is the class that SMSClient is expected to thrown, which the caller needs to handle properly.
 * It has the SMS specific errors which is useful for troubleshooting.
 *
 * @package SMS\Core
 */
